...
from app.routes_search import bp as search_bp
from app.routes_watches import bp as watches_bp
from enrolleagle_providers import get_provider_registry, get_search_registry, get_schools
...
def create_app(test_config: dict | None = None) -> Flask:
    ...
    app.extensions["search_registry"] = get_search_registry()
    app.extensions["schools"] = get_schools()
